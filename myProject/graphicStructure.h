...
gameWindow gameGraphicInit(int display_width, int display_height);

/* Finaliza sistema grafico Allegro 5.0 */
void gameGraphicDeinit(gameWindow display);
...
#define DOURADO_GOLD              PIXEL(255,215,0)
...
#define ROSA_PINK                 PIXEL(234, 35, 94)
#define ROSA_DEEP_PINK            PIXEL(255,20,147)
...
#define ROXO_PINK                 PIXEL(194,34,135)
...
#define VERDE_AGUA                PIXEL(0,206,209)
